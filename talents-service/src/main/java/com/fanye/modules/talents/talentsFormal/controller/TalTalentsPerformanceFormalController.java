...
*/
    @Api(tags = {""})
    @RestController
@RequestMapping("/performanceFormal")
public class TalTalentsPerformanceFormalController {

    @DubboReference
    private ITalTalentsPerformanceFormalService talTalentsPerformanceService;
    ...
    @GetMapping("/query")
    public Result queryListByPage(TalTalentsPerformanceFormal talTalentsPerformance,
    ...
    @PostMapping("/add")
    public Result add(@RequestBody TalTalentsPerformanceFormal talTalentsPerformance){
    ...
    @PostMapping("/update")
    public Result update(@RequestBody TalTalentsPerformanceFormal talTalentsPerformance){
