...
public class TalTalentsOtherinfoController {

    @DubboReference
    private ITalTalentsOtherinfoService talTalentsOtherinfoService;
    ...
    @GetMapping("/query")
    public Result queryListByPage(TalTalentsOtherinfo talTalentsOtherinfo,
    ...
    @PostMapping("/add")
    public Result add(@RequestBody TalTalentsOtherinfo talTalentsOtherinfo){
    ...
    @PostMapping("/update")
    public Result update(@RequestBody TalTalentsOtherinfo talTalentsOtherinfo){
